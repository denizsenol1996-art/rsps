...
data class GroundItem(
    ...
    constructor(item : GameItem, owner: Optional<Player>, pos: Position) : this(item = item, owner = owner, pos = pos, GroundItemPickupState.REGULAR, null, DateTime.now(),false)

    constructor(item : GameItem, pos: Position) : this(item = item, owner = Optional.empty(), pos = pos, GroundItemPickupState.REGULAR, null, DateTime.now(),false)

    constructor(item : GameItem, pos: Position, customDelayTime : Int) : this(item = item, owner = Optional.empty(), pos = pos, GroundItemPickupState.REGULAR, null, DateTime.now(),false,customDelayTime)
